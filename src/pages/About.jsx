    ...
    <>
      ...
      <div className="px-7 py-7 flex flex-col flex-col-reverse md:flex md:flex-row md:items-center md:justify-between pt-3">
        <div className="flex flex-col gap-y-4">
          ...
          <p className="text-xl lg:text-lg/loose text-gray-500 text-center md:text-justify font-normal tracking-tigh md:flex-grow">
    {configData.aboutDesc}
  </p>
  <img className="border rounded-md p-3 grayscale shadow-md" src="https://res.cloudinary.com/dakbbymwz/image/upload/v1711653876/Cv/xzcmxjskxtzigh145cow.jpg" alt="Self Portrait" />
</div>
        </div>
      </div>
